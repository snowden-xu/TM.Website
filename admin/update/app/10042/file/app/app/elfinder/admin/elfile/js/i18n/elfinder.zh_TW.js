...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.zh_TW = {
		...
		messages   : {
			...
			'cmdinfo'      : '查看關於',
			'cmdmkdir'     : '建立資料夾',
                        'cmdmkdirin'   : '放入新的資料夾', // from v2.1.7 added 19.2.2016
			'cmdmkfile'    : '建立文字檔案',
			'cmdopen'      : '打開',
			'cmdpaste'     : '貼上',
			'cmdquicklook' : '預覽',
			...
			'cmdplaces'    : '添加到位置', // added 28.12.2014
			'cmdchmod'     : '改變模式', // from v2.1 added 20.6.2015
			'cmdopendir'   : '打開一個資料夾', // from v2.1 added 13.1.2016
			...
			'btnCwd'    : '當前',      // from v2.1 added 22.5.2015
			'btnVolume' : '上一級',    // from v2.1 added 22.5.2015
			'btnAll'    : '全部',       // from v2.1 added 22.5.2015
			'btnMime'   : '類型', // from v2.1 added 22.5.2015
			'btnFileName':'名稱',  // from v2.1 added 22.5.2015
			'btnSaveClose': '保存並關閉', // from v2.1 added 12.6.2015
			'btnBackup' : '保留', // fromv2.1 added 28.11.2015
			...
			'ntfloadimg'  : '正在讀取圖片',
                        ...
                        'ntfdim'      : '獲取影像維數',
                        'ntfpreupload': '驗證上傳檔名', // from v2.1 added 31.11.2015
                        'ntfzipdl'    : '創建下載檔案', // from v2.1.7 added 23.1.2016
			...
			'pass'            : '密碼', // added 18.04.2012
                        'confirmUnmount'      : '你卸載 $1?',  // from v2.1 added 30.04.2012
			'dropFilesBrowser': '從瀏覽器中删除或粘貼檔案', // from v2.1 added 30.05.2012
			'dropPasteFiles'  : '删除或粘貼檔案和網址在這裡', // from v2.1 added 07.04.2014
			'encoding'        : '編碼', // from v2.1 added 19.12.2014
			'locale'          : '區域設置',   // from v2.1 added 19.12.2014
			'searchTarget'    : '目標: $1',                // from v2.1 added 22.5.2015
			'searchMime'      : '通過輸入MIME類型蒐索', // from v2.1 added 22.5.2015
			...
			'emptyFolderDrop' : '資料夾是空的', // from v2.1.6 added 30.12.2015
			'emptyFolderLTap' : '資料夾是空的', // from v2.1.6 added 30.12.2015
			'quality'         : 'Quality', // from v2.1.6 added 5.1.2016
			'autoSync'        : '自動同步',  // from v2.1.6 added 10.1.2016
			'moveUp'          : '向上移動',  // from v2.1.6 added 18.1.2016
