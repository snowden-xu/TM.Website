...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.zh_CN = {
		...
		messages   : {
			...
			'cmdinfo'      : '查看信息',
			'cmdmkdir'     : '新建文件夹',
                        'cmdmkdirin'   : '放入新的文件夹', // from v2.1.7 added 19.2.2016
			'cmdmkfile'    : '新建文本文件',
			'cmdopen'      : '打开',
			'cmdpaste'     : '粘贴',
			'cmdquicklook' : '预览',
			...
			'cmdopendir'   : '打开一个文件夹', // from v2.1 added 13.1.2016
			...
			'btnCwd'    : '当前',      // from v2.1 added 22.5.2015
			'btnVolume' : '上一级',    // from v2.1 added 22.5.2015
			'btnAll'    : '全部',       // from v2.1 added 22.5.2015
			'btnMime'   : '类型', // from v2.1 added 22.5.2015
			'btnFileName':'名称',  // from v2.1 added 22.5.2015
			...
			'ntfdim'      : '获取图像维数',
                        'ntfpreupload': '验证上传文件名', // from v2.1 added 31.11.2015
                        'ntfzipdl'    : '创建下载文件', // from v2.1.7 added 23.1.2016
			...
			'pass'            : '密码', // added 18.04.2012
                        'confirmUnmount'  : '你卸载 $1?',  // from v2.1 added 30.04.2012
			'dropFilesBrowser': '从浏览器中删除或粘贴文件', // from v2.1 added 30.05.2012
			'dropPasteFiles'  : '删除或粘贴文件和网址在这里', // from v2.1 added 07.04.2014
			'encoding'        : '编码', // from v2.1 added 19.12.2014
			'locale'          : '区域设置',   // from v2.1 added 19.12.2014
			'searchTarget'    : '目标: $1',                // from v2.1 added 22.5.2015
			'searchMime'      : '通过输入MIME类型搜索', // from v2.1 added 22.5.2015
			'owner'           : '业主', // from v2.1 added 20.6.2015
			...
			'emptyFolderDrop' : '文件夹是空的', // from v2.1.6 added 30.12.2015
			'emptyFolderLTap' : '文件夹是空的', // from v2.1.6 added 30.12.2015
			'quality'         : '质量', // from v2.1.6 added 5.1.2016
